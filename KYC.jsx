...
const ID_TYPES = [
  { value:'passport',       label:'馃泜 Passport'       },
  { value:'national_id',    label:'馃 National ID'    },
  { value:'driver_license', label:'馃殫 Driver License' },
];
...
/* 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€ main component 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€ */
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-6">
      <motion.div
        ...
        <p className="text-gray-400 mb-6">
          Your documents have been submitted for review. We'll notify you within 24鈥�48 hours.
        </p>
        <a href="/profile"
      ...
      <div className="max-w-lg mx-auto px-4 mt-6">
        ...
        <AnimatePresence mode="wait">
          <motion.div key={step}
            ...
            {/* 鈺愨晲鈺愨晲鈺愨晲 STEP 0 鈥� Personal Info 鈺愨晲鈺愨晲鈺愨晲 */}
            {step === 0 && (
            ...
            {/* 鈺愨晲鈺愨晲鈺愨晲 STEP 1 鈥� Document 鈺愨晲鈺愨晲鈺愨晲 */}
            {step === 1 && (
              <div className="bg-gray-800 rounded-xl p-6 space-y-5">
                ...
                <UploadZone
                  ...
                  hint="Clear photo 鈥� all four corners visible"
                ...
                <InfoBox text="Accepted: JPG, PNG, PDF 鈥� max 5 MB per file." />
              </div>
            )}

            {/* 鈺愨晲鈺愨晲鈺愨晲 STEP 2 鈥� Selfie 鈺愨晲鈺愨晲鈺愨晲 */}
            {step === 2 && (
              <div className="bg-gray-800 rounded-xl p-6 space-y-5">
                <h2 className="text-white font-bold text-lg flex items-center gap-2">
                ...
                <ul className="text-gray-400 text-sm space-y-1 list-disc list-inside">
                  ...
                  <li>Good lighting 鈥� no glare or shadows</li>
            ...
            {/* 鈺愨晲鈺愨晲鈺愨晲 STEP 3 鈥� Review 鈺愨晲鈺愨晲鈺愨晲 */}
            {step === 3 && (
              <div className="bg-gray-800 rounded-xl p-6 space-y-5">
                <h2 className="text-white font-bold text-lg flex items-center gap-2">
                ...
                <InfoBox
                  text="By submitting, you confirm all information is accurate. Processing takes 24鈥�48 hours."
                  type="warning" />
              </div>
            )}
        ...
        <div className="flex gap-3 mt-6">
          ...
          {step < STEPS.length - 1 ? (
            ...
            <button
              ...
              {status === 'submitting' ? 'Submitting...' : '鉁� Submit KYC'}
            </button>
          )}
        </div>
      </div>
